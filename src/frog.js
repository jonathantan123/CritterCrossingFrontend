class Frog {
    ...
    static reset(){
        this.tag.style.top = `${GameBoard.BOTTOM_EDGE - 27}px`
        this.tag.style.left = `${GameBoard.RIGHT_EDGE/2}px`
    }
    ...
    static moveFrog(dir) {
        ...
        Frog.checkConflict(Prize.tag, "win")
        Vehicles.tags.forEach(checkConflict)
        
    }

    static checkConflict(itemTag, result = "lose"){
